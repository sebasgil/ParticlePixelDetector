...
def test_random_sphere_vector():
    ...
    g = DetectorGeometry()
    oGen = generation.OrientationGenerator(g, 0)
    test_vector = oGen.generate_random_sphere_vector()
...
def test_orientation_vector():
    ...
    g = DetectorGeometry()
    oGen = generation.OrientationGenerator(g, 0)
    opening_angle = g.source_opening_angle # * np.pi / 180
    line_of_sight = g.source_direction
    test_orientation = oGen.generate_orientation_vector()
